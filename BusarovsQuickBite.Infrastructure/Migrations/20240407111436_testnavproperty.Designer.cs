...
namespace BusarovsQuckBite.Migrations
{
    ...
    [Migration("20240407111436_testnavproperty")]
            ...
            modelBuilder.Entity("BusarovsQuckBite.Data.Models.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "21ad7f1e-13cc-47b1-b543-de1ff7695de8",
                            Name = "Admin",
                            NormalizedName = "ADMIN",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 14, 14, 36, 82, DateTimeKind.Local).AddTicks(2822)
                        },
                        new
                        {
                            Id = "fa175b24-e5a7-41ab-8237-94734f2b5408",
                            ConcurrencyStamp = "b88a8a13-0025-4fa9-bebd-a465417ec131",
                            Name = "Customer",
                            NormalizedName = "CUSTOMER",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 14, 14, 36, 82, DateTimeKind.Local).AddTicks(2829)
                        },
                        new
                        {
                            Id = "22ccb117-1c50-47a5-bc43-1d9a84879e10",
                            ConcurrencyStamp = "d7b8e430-28ac-4070-9a6f-1e00a5577965",
                            Name = "Delivery Driver",
                            NormalizedName = "DELIVERY DRIVER",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 14, 14, 36, 82, DateTimeKind.Local).AddTicks(2888)
                        },
                        new
                        {
                            Id = "a1a8637e-6e83-4ee9-adef-09cd724473a7",
                            ConcurrencyStamp = "188a99ac-fbd2-4f20-909d-44fcad31c33f",
                            Name = "Cooking Staff",
                            NormalizedName = "COOKING STAFF",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 14, 14, 36, 82, DateTimeKind.Local).AddTicks(2897)
                        });
                });
            ...
            modelBuilder.Entity("BusarovsQuckBite.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "5fbf8659-d14a-4f9b-887b-f6b50ff8f08a",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEBJLEzPZAa89f50HI+3pg07lgfcw61a39eNbiPf5dxoK8hSL91unZkLPK+P5T/95vA==",
                            PhoneNumber = "0896722926",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "142d1769-2725-4fa0-8355-8e79d6277428",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 14, 14, 36, 82, DateTimeKind.Local).AddTicks(2652),
            ...
            modelBuilder.Entity("BusarovsQuckBite.Data.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Snacks",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 14, 14, 36, 82, DateTimeKind.Local).AddTicks(3739),
                        ...
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Burgers",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 14, 14, 36, 82, DateTimeKind.Local).AddTicks(3749),
                            Who = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Drinks",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 14, 14, 36, 82, DateTimeKind.Local).AddTicks(3751),
                            Who = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Pizzas",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 14, 14, 36, 82, DateTimeKind.Local).AddTicks(3753),
                            Who = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Pasta",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 14, 14, 36, 82, DateTimeKind.Local).AddTicks(3755),
                            Who = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Sandwiches",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 14, 14, 36, 82, DateTimeKind.Local).AddTicks(3757),
                            Who = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Desserts",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 14, 14, 36, 82, DateTimeKind.Local).AddTicks(3759),
                            Who = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        });
                });
            ...
            modelBuilder.Entity("BusarovsQuckBite.Data.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 15.00m,
                            Quantity = 10,
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 14, 14, 36, 82, DateTimeKind.Local).AddTicks(4575),
                            Who = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        },
                        new
                        {
                            ...
                            Price = 5.00m,
                            Quantity = 50,
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 14, 14, 36, 82, DateTimeKind.Local).AddTicks(4585),
                            Who = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        },
                        new
                        {
                            ...
                            Price = 8.50m,
                            Quantity = 15,
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 14, 14, 36, 82, DateTimeKind.Local).AddTicks(4588),
                            Who = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        });
                });
