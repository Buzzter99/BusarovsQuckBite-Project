...
namespace BusarovsQuckBite.Migrations
{
    ...
    [Migration("20240407181959_addMessagesEntity3")]
    partial class addMessagesEntity3
    {
            ...
            modelBuilder.Entity("BusarovsQuckBite.Data.Models.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "937ac085-2ece-4251-9920-b867ce33b1c0",
                            Name = "Admin",
                            NormalizedName = "ADMIN",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 21, 19, 59, 369, DateTimeKind.Local).AddTicks(7282)
                        },
                        new
                        {
                            Id = "fa175b24-e5a7-41ab-8237-94734f2b5408",
                            ConcurrencyStamp = "37d02f8d-d3dd-4378-9875-c6b36d510840",
                            Name = "Customer",
                            NormalizedName = "CUSTOMER",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 21, 19, 59, 369, DateTimeKind.Local).AddTicks(7289)
                        },
                        new
                        {
                            Id = "22ccb117-1c50-47a5-bc43-1d9a84879e10",
                            ConcurrencyStamp = "82a140a3-6b3a-4f4d-b979-356608eb0e19",
                            Name = "Delivery Driver",
                            NormalizedName = "DELIVERY DRIVER",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 21, 19, 59, 369, DateTimeKind.Local).AddTicks(7297)
                        },
                        new
                        {
                            Id = "a1a8637e-6e83-4ee9-adef-09cd724473a7",
                            ConcurrencyStamp = "0c6cb3ef-d471-43ad-8401-860383c5adcd",
                            Name = "Cooking Staff",
                            NormalizedName = "COOKING STAFF",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 21, 19, 59, 369, DateTimeKind.Local).AddTicks(7302)
                        });
                });
            ...
            modelBuilder.Entity("BusarovsQuckBite.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "02dda234-0326-472c-bc87-d9745871d976",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEJnmBcagNLTZngrFxpW1v1hgfstUItQhN8nATLyoc/+YbyIRf5yG/ilpBK61RTiE8A==",
                            PhoneNumber = "0896722926",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "a982c427-00c0-4404-92af-c22433d99271",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 21, 19, 59, 369, DateTimeKind.Local).AddTicks(7120),
            ...
            modelBuilder.Entity("BusarovsQuckBite.Data.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Snacks",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 21, 19, 59, 369, DateTimeKind.Local).AddTicks(8237),
                        ...
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Burgers",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 21, 19, 59, 369, DateTimeKind.Local).AddTicks(8249),
                            Who = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Drinks",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 21, 19, 59, 369, DateTimeKind.Local).AddTicks(8251),
                            Who = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Pizzas",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 21, 19, 59, 369, DateTimeKind.Local).AddTicks(8253),
                            Who = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Pasta",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 21, 19, 59, 369, DateTimeKind.Local).AddTicks(8254),
                            Who = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Sandwiches",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 21, 19, 59, 369, DateTimeKind.Local).AddTicks(8257),
                            Who = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Desserts",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 21, 19, 59, 369, DateTimeKind.Local).AddTicks(8259),
                            Who = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        });
                });
            ...
            modelBuilder.Entity("BusarovsQuckBite.Data.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 15.00m,
                            Quantity = 10,
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 21, 19, 59, 369, DateTimeKind.Local).AddTicks(9110),
                            Who = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        },
                        new
                        {
                            ...
                            Price = 5.00m,
                            Quantity = 50,
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 21, 19, 59, 369, DateTimeKind.Local).AddTicks(9122),
                            Who = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        },
                        new
                        {
                            ...
                            Price = 8.50m,
                            Quantity = 15,
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 21, 19, 59, 369, DateTimeKind.Local).AddTicks(9124),
                            Who = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        });
                });
