...
namespace BusarovsQuckBite.Migrations
{
    ...
    [Migration("20240407190550_addColumnToMessage")]
    partial class addColumnToMessage
    {
            ...
            modelBuilder.Entity("BusarovsQuckBite.Data.Models.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "ed80a42c-cded-4372-a970-7e7343431052",
                            Name = "Admin",
                            NormalizedName = "ADMIN",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 22, 5, 50, 16, DateTimeKind.Local).AddTicks(7419)
                        },
                        new
                        {
                            Id = "fa175b24-e5a7-41ab-8237-94734f2b5408",
                            ConcurrencyStamp = "a0014e1b-50ac-4ae8-89f0-b1e13bf46917",
                            Name = "Customer",
                            NormalizedName = "CUSTOMER",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 22, 5, 50, 16, DateTimeKind.Local).AddTicks(7428)
                        },
                        new
                        {
                            Id = "22ccb117-1c50-47a5-bc43-1d9a84879e10",
                            ConcurrencyStamp = "f7482e57-7874-418f-9aa3-97818d371177",
                            Name = "Delivery Driver",
                            NormalizedName = "DELIVERY DRIVER",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 22, 5, 50, 16, DateTimeKind.Local).AddTicks(7433)
                        },
                        new
                        {
                            Id = "a1a8637e-6e83-4ee9-adef-09cd724473a7",
                            ConcurrencyStamp = "a4956268-85b4-4b31-93e0-2a797f620a07",
                            Name = "Cooking Staff",
                            NormalizedName = "COOKING STAFF",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 22, 5, 50, 16, DateTimeKind.Local).AddTicks(7441)
                        });
                });
            ...
            modelBuilder.Entity("BusarovsQuckBite.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "65e77d71-939e-4680-873a-12221df8db7c",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAENXwgbx3UyLrER+FfvcZgjs5N9oOL+yXiUOfx21rG2Nd499kGOIFLjVw/3F5kYcp3Q==",
                            PhoneNumber = "0896722926",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "4df4528a-0bca-4856-9e58-d1e5a5c3735b",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 22, 5, 50, 16, DateTimeKind.Local).AddTicks(7249),
            ...
            modelBuilder.Entity("BusarovsQuckBite.Data.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Snacks",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 22, 5, 50, 16, DateTimeKind.Local).AddTicks(8266),
                        ...
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Burgers",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 22, 5, 50, 16, DateTimeKind.Local).AddTicks(8276),
                            Who = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Drinks",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 22, 5, 50, 16, DateTimeKind.Local).AddTicks(8278),
                            Who = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Pizzas",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 22, 5, 50, 16, DateTimeKind.Local).AddTicks(8280),
                            Who = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Pasta",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 22, 5, 50, 16, DateTimeKind.Local).AddTicks(8282),
                            Who = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Sandwiches",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 22, 5, 50, 16, DateTimeKind.Local).AddTicks(8284),
                            Who = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Desserts",
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 22, 5, 50, 16, DateTimeKind.Local).AddTicks(8286),
                            Who = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        });
                });
            ...
            modelBuilder.Entity("BusarovsQuckBite.Data.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 15.00m,
                            Quantity = 10,
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 22, 5, 50, 16, DateTimeKind.Local).AddTicks(9098),
                            Who = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        },
                        new
                        {
                            ...
                            Price = 5.00m,
                            Quantity = 50,
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 22, 5, 50, 16, DateTimeKind.Local).AddTicks(9109),
                            Who = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        },
                        new
                        {
                            ...
                            Price = 8.50m,
                            Quantity = 15,
                            TransactionDateAndTime = new DateTime(2024, 4, 7, 22, 5, 50, 16, DateTimeKind.Local).AddTicks(9111),
                            Who = "8e445865-a24d-4543-a6c6-9443d048cdb9"
                        });
                });
